...
CREATE TABLE resumen_diario (
  resumen_diario_id bigint(20) NOT NULL AUTO_INCREMENT,
  fecha_gen_xml datetime(6) DEFAULT NULL,
  customization_id varchar(255) DEFAULT NULL,
  ...
  ticket_operacion bigint(20) DEFAULT NULL,
  ticket_sunat varchar(255) DEFAULT NULL,
  xml_hash varchar(255) DEFAULT NULL,
  empresa_id int(11) NOT NULL,
  PRIMARY KEY (resumen_diario_id),
  KEY fk_resumen_diario_empresa_id (empresa_id),
...
CREATE TABLE resumen_diario_det (
  resumen_diario_det_id bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  resumen_diario_id bigint(20) NOT NULL,
  PRIMARY KEY (resumen_diario_det_id),
  KEY fk_resumen_diario_det_resumen_diario (resumen_diario_id),
...
CREATE TABLE resumen_diario_tax (
  resumen_diario_tax_id bigint(20) NOT NULL AUTO_INCREMENT,
  cod_tip_tributo_rd varchar(255) DEFAULT NULL,
  id_lineard int(11) DEFAULT NULL,
  ...
  KEY fk_resumen_diario_tax_resumen_diario (resumen_diario_id),
